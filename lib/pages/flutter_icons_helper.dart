...
class FlutterIconHelper extends StatefulWidget {
  const FlutterIconHelper({super.key});

  @override
  State<FlutterIconHelper> createState() => _FlutterIconHelperState();
}

class _FlutterIconHelperState extends State<FlutterIconHelper> {
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return Tooltip(
                        ...
                        child: GestureDetector(
                          ...
                          child: Card(
                            child: xIcon(icon: Icon(currentIcon.value)),
                          ),
                        ),
                      );
                    },
